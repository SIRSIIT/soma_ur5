...
def move1():
    ...
    try:
        ...
        joints_pos2 = [joints_pos[0]-0.4, joints_pos[1], joints_pos[2], joints_pos[3], joints_pos[4], joints_pos[5]];
        print("POS: " + str(joints_pos));
        print("POS2: " + str(joints_pos2));
        g.trajectory.points = [
            JointTrajectoryPoint(positions=joints_pos, velocities=[0]*6, time_from_start=rospy.Duration(0.0)),
            JointTrajectoryPoint(positions=joints_pos2, velocities=[0]*6, time_from_start=rospy.Duration(0.10))
        ]
